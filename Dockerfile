...
RUN apt-get update && apt-get install -y locales git-core libsqlite3-dev libicu-dev libldap2-dev libfreetype6-dev libjpeg62-turbo-dev mariadb-client php7.3-mysql libmcrypt-dev libpq-dev libexif-dev libmcrypt-dev libjpeg-dev && rm -rf /var/lib/apt/lists/* \
